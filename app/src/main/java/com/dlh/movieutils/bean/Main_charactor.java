 ...
 */
public class Main_charactor implements Parcelable {
    ...
    public Main_charactor() {
    }

    protected Main_charactor(Parcel in) {
        this.id = in.readLong();
    ...
    public static final Creator<Main_charactor> CREATOR = new Creator<Main_charactor>() {
        @Override
        public Main_charactor createFromParcel(Parcel source) {
            return new Main_charactor(source);
        }

        @Override
        public Main_charactor[] newArray(int size) {
            return new Main_charactor[size];
        }
    };
}